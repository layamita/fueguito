...
class CreateConversionsLastTable extends Migration {
	...
	public function up()
	{
		Schema::connection('gollum')->create('conversions_last', function(Blueprint $table)
		{
			$table->integer('conversion_id', true);
	...
	{
		Schema::connection('gollum')->drop('conversions_last');
	}
