...
class CreateVisitsMaxTimeTable extends Migration {
	...
	public function up()
	{
		Schema::connection('gollum')->create('visits_max_time', function(Blueprint $table)
		{
			$table->bigInteger('visit_id', true);
			...
			$table->index(['country_code','traffic_source_id','os_version','connection_type','mobile_carrier'], 'country_code');
		});
	}
	...
	{
		Schema::connection('gollum')->drop('visits_max_time');
	}
