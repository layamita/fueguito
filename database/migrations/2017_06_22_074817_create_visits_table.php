...
class CreateVisitsTable extends Migration {
	...
	public function up()
	{
		Schema::connection('gollum')->create('visits', function(Blueprint $table)
		{
			...
			$table->string('os', 100)->nullable()->index('os');
			...
			$table->index(['country_code','mobile_carrier'], 'country_code');
			$table->index(['os','os_version'], 'os_2');
		});
	}
	...
	{
		Schema::connection('gollum')->drop('visits');
	}
