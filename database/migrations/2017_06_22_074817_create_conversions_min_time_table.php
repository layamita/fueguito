...
class CreateConversionsMinTimeTable extends Migration {
	...
	public function up()
	{
		Schema::connection('gollum')->create('conversions_min_time', function(Blueprint $table)
		{
	...
	{
		Schema::connection('gollum')->drop('conversions_min_time');
	}
