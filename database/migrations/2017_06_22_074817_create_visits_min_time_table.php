...
class CreateVisitsMinTimeTable extends Migration {
	...
	public function up()
	{
		Schema::connection('gollum')->create('visits_min_time', function(Blueprint $table)
		{
	...
	{
		Schema::connection('gollum')->drop('visits_min_time');
	}
